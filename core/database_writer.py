...
class DatabaseWriter:
    def __init__(self, database, batch_size: int = 1_000, queue_size: int = 10_000):
    ...
    def submit(self, sql: str, params: tuple[Any, ...]) -> None:
        ...
        self.queue.put((sql, params))  # bounded queue deliberately applies producer backpressure
